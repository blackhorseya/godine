...
type Order struct {
	...
	RestaurantID uuid.UUID `json:"restaurantId,omitempty" bson:"restaurantId"`
	...
	TotalAmount float64 `json:"totalAmount,omitempty" bson:"totalAmount"`
...
type OrderItem struct {
	...
	MenuItemID uuid.UUID `json:"menuItemId,omitempty" bson:"menuItemId"`
