...
func (mr *MockIOrderBizMockRecorder) AddOrderItem(ctx, orderID, item interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddOrderItem", reflect.TypeOf((*MockIOrderBiz)(nil).AddOrderItem), ctx, orderID, item)
}
...
func (mr *MockIOrderBizMockRecorder) CreateOrder(ctx, userID, restaurantID, items, address, totalAmount interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIOrderBizMockRecorder) DeleteOrder(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteOrder", reflect.TypeOf((*MockIOrderBiz)(nil).DeleteOrder), ctx, id)
}
...
func (mr *MockIOrderBizMockRecorder) GetOrder(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIOrderBizMockRecorder) ListOrders(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIOrderBizMockRecorder) ListOrdersByRestaurant(ctx, restaurantID, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIOrderBizMockRecorder) ListOrdersByUser(ctx, userID, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// RemoveOrderItem indicates an expected call of RemoveOrderItem.
func (mr *MockIOrderBizMockRecorder) RemoveOrderItem(ctx, orderID, menuItemID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveOrderItem", reflect.TypeOf((*MockIOrderBiz)(nil).RemoveOrderItem), ctx, orderID, menuItemID)
}
...
func (mr *MockIOrderBizMockRecorder) UpdateOrderStatus(ctx, id, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
