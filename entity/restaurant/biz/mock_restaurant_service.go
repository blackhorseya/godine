...
func (m *MockIRestaurantBiz) ChangeRestaurantStatus(ctx contextx.Contextx, restaurantID uuid.UUID, isOpen bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockIRestaurantBizMockRecorder) ChangeRestaurantStatus(ctx, restaurantID, isOpen interface{}) *gomock.Call {
...
func (mr *MockIRestaurantBizMockRecorder) CreateRestaurant(ctx, name, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIRestaurantBiz) DeleteRestaurant(ctx contextx.Contextx, id uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockIRestaurantBizMockRecorder) DeleteRestaurant(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIRestaurantBiz) GetRestaurant(ctx contextx.Contextx, id uuid.UUID) (*model.Restaurant, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRestaurantBizMockRecorder) GetRestaurant(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIRestaurantBiz) UpdateRestaurant(ctx contextx.Contextx, id uuid.UUID, name string, address model.Address) error {
	m.ctrl.T.Helper()
...
func (mr *MockIRestaurantBizMockRecorder) UpdateRestaurant(ctx, id, name, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
