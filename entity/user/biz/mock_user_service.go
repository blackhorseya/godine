...
func (m *MockIUserBiz) ChangeUserStatus(ctx contextx.Contextx, userID uuid.UUID, isActive bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) ChangeUserStatus(ctx, userID, isActive interface{}) *gomock.Call {
...
func (mr *MockIUserBizMockRecorder) CreateUser(ctx, name, email, password, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIUserBiz) DeleteUser(ctx contextx.Contextx, id uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) DeleteUser(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUser", reflect.TypeOf((*MockIUserBiz)(nil).DeleteUser), ctx, id)
}

// GetUser mocks base method.
func (m *MockIUserBiz) GetUser(ctx contextx.Contextx, id uuid.UUID) (*model.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) GetUser(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) ListUsers(ctx, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) SearchUsers(ctx, keyword interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIUserBiz) UpdateUser(ctx contextx.Contextx, id uuid.UUID, name, email, password string, address model.Address) error {
	m.ctrl.T.Helper()
...
func (mr *MockIUserBizMockRecorder) UpdateUser(ctx, id, name, email, password, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
