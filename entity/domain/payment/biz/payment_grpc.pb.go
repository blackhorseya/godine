...
func (c *paymentServiceClient) CreatePayment(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*model.Payment, error) {
	out := new(model.Payment)
...
func (c *paymentServiceClient) GetPayment(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*model.Payment, error) {
	out := new(model.Payment)
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "entity/domain/payment/biz/payment.proto",
}
