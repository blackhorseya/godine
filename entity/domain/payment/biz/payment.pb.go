...
func file_domain_payment_biz_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_domain_payment_biz_payment_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_domain_payment_biz_payment_proto_msgTypes[3].Exporter = func(v any, i int) any {
