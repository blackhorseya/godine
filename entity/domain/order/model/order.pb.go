...
func file_domain_order_model_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_domain_order_model_order_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_domain_order_model_order_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_domain_order_model_order_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_domain_order_model_order_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
