...
// Create mocks base method.
func (m *MockIUserRepo) Create(c context.Context, user *model.Account) error {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockIUserRepoMockRecorder) Create(c, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockIUserRepo)(nil).Create), c, user)
}
...
// List mocks base method.
func (m *MockIUserRepo) List(c context.Context, cond ListCondition) ([]*model.Account, int, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockIUserRepo) Update(c context.Context, user *model.Account) error {
	m.ctrl.T.Helper()
...
// Update indicates an expected call of Update.
func (mr *MockIUserRepoMockRecorder) Update(c, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIUserRepo)(nil).Update), c, user)
}
