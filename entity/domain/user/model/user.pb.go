...
func (x *Account) Reset() {
	*x = Account{}
	if protoimpl.UnsafeEnabled {
		mi := &file_entity_domain_user_model_user_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Account) Descriptor() ([]byte, []int) {
	return file_entity_domain_user_model_user_proto_rawDescGZIP(), []int{2}
}
...
var file_entity_domain_user_model_user_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x66, 0x0a, 0x07,
...
var file_entity_domain_user_model_user_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_entity_domain_user_model_user_proto_goTypes = []any{
...
func file_entity_domain_user_model_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_entity_domain_user_model_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_entity_domain_user_model_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Role); i {
			case 0:
				return &v.state
			case 1:
		...
		file_entity_domain_user_model_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
