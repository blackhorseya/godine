...
// 	protoc        v3.20.3
// source: entity/domain/logistics/model/logistics.proto
...
func (DeliveryStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_entity_domain_logistics_model_logistics_proto_enumTypes[0].Descriptor()
}

func (DeliveryStatus) Type() protoreflect.EnumType {
	return &file_entity_domain_logistics_model_logistics_proto_enumTypes[0]
}
...
func (DeliveryStatus) EnumDescriptor() ([]byte, []int) {
	return file_entity_domain_logistics_model_logistics_proto_rawDescGZIP(), []int{0}
}
...
func (x *Address) Reset() {
	*x = Address{}
	if protoimpl.UnsafeEnabled {
		mi := &file_entity_domain_logistics_model_logistics_proto_msgTypes[0]
...
func (x *Delivery) Reset() {
	*x = Delivery{}
	if protoimpl.UnsafeEnabled {
		mi := &file_entity_domain_logistics_model_logistics_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Delivery) Descriptor() ([]byte, []int) {
	return file_entity_domain_logistics_model_logistics_proto_rawDescGZIP(), []int{1}
}
...
var File_entity_domain_logistics_model_logistics_proto protoreflect.FileDescriptor

var file_entity_domain_logistics_model_logistics_proto_rawDesc = []byte{
	0x0a, 0x2d, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2f,
	0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f,
	0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x09, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x66, 0x0a, 0x07, 0x41,
...
var (
	file_entity_domain_logistics_model_logistics_proto_rawDescOnce sync.Once
	file_entity_domain_logistics_model_logistics_proto_rawDescData = file_entity_domain_logistics_model_logistics_proto_rawDesc
)

func file_entity_domain_logistics_model_logistics_proto_rawDescGZIP() []byte {
	file_entity_domain_logistics_model_logistics_proto_rawDescOnce.Do(func() {
		file_entity_domain_logistics_model_logistics_proto_rawDescData = protoimpl.X.CompressGZIP(file_entity_domain_logistics_model_logistics_proto_rawDescData)
	})
	return file_entity_domain_logistics_model_logistics_proto_rawDescData
}

var file_entity_domain_logistics_model_logistics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_entity_domain_logistics_model_logistics_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_entity_domain_logistics_model_logistics_proto_goTypes = []any{
...
func init() { file_entity_domain_logistics_model_logistics_proto_init() }
func file_entity_domain_logistics_model_logistics_proto_init() {
	if File_entity_domain_logistics_model_logistics_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_entity_domain_logistics_model_logistics_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_entity_domain_logistics_model_logistics_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_entity_domain_logistics_model_logistics_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_entity_domain_logistics_model_logistics_proto_goTypes,
		DependencyIndexes: file_entity_domain_logistics_model_logistics_proto_depIdxs,
		EnumInfos:         file_entity_domain_logistics_model_logistics_proto_enumTypes,
		MessageInfos:      file_entity_domain_logistics_model_logistics_proto_msgTypes,
	}.Build()
	File_entity_domain_logistics_model_logistics_proto = out.File
	file_entity_domain_logistics_model_logistics_proto_rawDesc = nil
	file_entity_domain_logistics_model_logistics_proto_goTypes = nil
	file_entity_domain_logistics_model_logistics_proto_depIdxs = nil
}
