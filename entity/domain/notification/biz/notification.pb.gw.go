...
func request_NotificationService_ListMyNotifications_0(ctx context.Context, marshaler runtime.Marshaler, client NotificationServiceClient, req *http.Request, pathParams map[string]string) (NotificationService_ListMyNotificationsClient, runtime.ServerMetadata, error) {
	var protoReq ListMyNotificationsRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.ListMyNotifications(ctx, &protoReq)
	if err != nil {
...
func RegisterNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_NotificationService_SendNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/notification.NotificationService/SendNotification", runtime.WithHTTPPathPattern("/notification.NotificationService/SendNotification"))
		if err != nil {
	...
	mux.Handle("POST", pattern_NotificationService_ListMyNotifications_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_NotificationService_SendNotification_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/notification.NotificationService/SendNotification", runtime.WithHTTPPathPattern("/notification.NotificationService/SendNotification"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_NotificationService_ListMyNotifications_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/notification.NotificationService/ListMyNotifications", runtime.WithHTTPPathPattern("/notification.NotificationService/ListMyNotifications"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_NotificationService_ListMyNotifications_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_NotificationService_SendNotification_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"notification.NotificationService", "SendNotification"}, ""))

	pattern_NotificationService_ListMyNotifications_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"notification.NotificationService", "ListMyNotifications"}, ""))
)

var (
	forward_NotificationService_SendNotification_0 = runtime.ForwardResponseMessage

	forward_NotificationService_ListMyNotifications_0 = runtime.ForwardResponseStream
)
