...
func (m *MockIMenuBiz) AddMenuItem(ctx contextx.Contextx, restaurantID uuid.UUID, name, description string, price float64) (*model.MenuItem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMenuBizMockRecorder) AddMenuItem(ctx, restaurantID, name, description, price interface{}) *gomock.Call {
...
func (m *MockIMenuBiz) GetMenuItem(ctx contextx.Contextx, restaurantID, menuItemID uuid.UUID) (*model.MenuItem, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMenuBizMockRecorder) GetMenuItem(ctx, restaurantID, menuItemID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIMenuBiz) RemoveMenuItem(ctx contextx.Contextx, restaurantID, menuItemID uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockIMenuBizMockRecorder) RemoveMenuItem(ctx, restaurantID, menuItemID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIMenuBiz) UpdateMenuItem(ctx contextx.Contextx, restaurantID, menuItemID uuid.UUID, name, description string, price float64, isAvailable bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockIMenuBizMockRecorder) UpdateMenuItem(ctx, restaurantID, menuItemID, name, description, price, isAvailable interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
